...
@Component({
  selector: 'app-add-register-prv',
  templateUrl: './add-register-prv.page.html',
  styleUrls: ['./add-register-prv.page.scss'],
})
export class AddRegisterPrvPage implements OnInit {
